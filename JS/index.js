...
const fragmentIndex = document.createDocumentFragment()
let carrito = {}
...
const renderCarrito = () => {
    ...
    Object.values(carrito).forEach(producto => {
        ...
        fragmentIndex.appendChild(clone)
    })
    totalProductos.appendChild(fragmentIndex)
    renderFooterCarrito()
...
const renderFooterCarrito = () => {
    ...
    fragmentIndex.appendChild(clone)
    footerCarrito.appendChild(fragmentIndex)
